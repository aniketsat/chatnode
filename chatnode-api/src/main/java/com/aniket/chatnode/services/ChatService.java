...
import com.aniket.chatnode.repositories.ChatRepository;
    ...
    public List<Chat> findAllByUserId(UUID userId) throws UserException {
        ...
        return chatRepository.findChatByUserId(user.getId()).stream()
                .sorted((chat1, chat2) -> {
                    ...
                    LocalDateTime timeStamp1 = chat1.getMessages().getLast().getTimeStamp();
                    LocalDateTime timeStamp2 = chat2.getMessages().getLast().getTimeStamp();
